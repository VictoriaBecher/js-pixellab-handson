...
console.warn(`Afiseaza propozitia “Am x prieteni: Larry, Steven si Carol.” Foloseste proprietatea length si apeleaza
...
console.warn(`Afiseaza propozitia: “Ma numesc xxx yyy si vreau sa invat javascript.” Foloseste notatia cu
paranteze patrate.`);
console.log(
  'Ma numesc ' +
    person.name +
...
console.warn(`Afiseaza propozitia “Am x prieteni: Larryson, Stevenson si Carolson.”. Foloseste proprietatea length
si apeleaza direct proprietatile name ale obiectelor.`);
console.log(
  'Am ' +
    person.friends.length +
    ' prieteni: ' +
...
console.warn(`Afiseaza propozitia “Numele meu este xxx yyy, am zz ani si n prieteni.”. Foloseste metoda length
