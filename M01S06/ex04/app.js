/**
 * Folosind exemplul de la exercitiul 2, afiseaza mesajul intr-un paragraf in loc de consola. Inainte de a adauga elementul in DOM adauga-i clasa message. https://developer.mozilla.org/en-US/docs/Web/API/Element/classList
