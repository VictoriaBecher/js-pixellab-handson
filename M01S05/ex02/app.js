...
const reclangle01Area = calculateRectangleArea(5, 3);
const reclangle02Area = calculateRectangleArea(3, 2);
console.log(reclangle01Area);
console.log(reclangle02Area);
...
console.warn(`Afiseaza suprafata totala a trei dreptunghiuri de 15 pe 31, 8 pe 9, respectiv 10 pe 5. Foloseste
variabile.
`);
const reclangleArea01 = calculateRectangleArea(15, 31);
const reclangleArea02 = calculateRectangleArea(8, 9);
const reclangleArea03 = calculateRectangleArea(10, 5);

totalArea = reclangleArea01 + reclangleArea02 + reclangleArea03;
